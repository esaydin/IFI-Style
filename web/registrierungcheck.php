...
<?php include_once 'header.php'; ?>
        ...
        if (!empty($_POST["benutzername"]) && !empty($_POST["kennwort"]) && !empty($_POST["kennwortwdhl"]) && !empty($_POST["vorname"]) && !empty($_POST["nachname"]) && !empty($_POST["email"])) {
            ...
            if (!empty($result)) {
                echo "<div id=\"fehler\">Die E-Mail Adresse existiert bereits.</div>";
            ...
            <div id="info">
                <div id="InhaltHöhe">
                      <br><a href="registrieren.php"> Zurück </a>
                    </div>
            </div>
       ...
       <?php include_once 'footer.php'; ?>
            ...
            $result = $db->connection($sql);
            if (!empty($result)) {
                echo "<div id=\"fehler\">Der Benutzername existiert bereits.</div>";
